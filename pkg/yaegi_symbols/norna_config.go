...
func init() {
	Symbols["code.vikunja.io/api/pkg/config/config"] = map[string]reflect.Value{
		...
		"MigrationNornaFileMaxFiles":                 reflect.ValueOf(config.MigrationNornaFileMaxFiles),
		"MigrationNornaFileMaxSize":                  reflect.ValueOf(config.MigrationNornaFileMaxSize),
		"MigrationNornaFileMaxUserStorage":           reflect.ValueOf(config.MigrationNornaFileMaxUserStorage),
